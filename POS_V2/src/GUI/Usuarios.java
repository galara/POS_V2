...
public class Usuarios extends javax.swing.JInternalFrame {
    ...
    public void setFiltroTexto() {
        ...
        Helper.setFiltraEntrada(puesto.getDocument(), FiltraEntrada.DEFAULT, 150, true);
        Helper.setFiltraEntrada(usuario.getDocument(), FiltraEntrada.DEFAULT, 100, true);
        Helper.setFiltraEntrada(password.getDocument(), FiltraEntrada.DEFAULT, 60, true);
        Helper.setFiltraEntrada(txtDato.getDocument(), FiltraEntrada.DEFAULT, 160, true);
    }
...
//    }
    ...
    private void initComponents() {
        ...
        nameusuario.setBackground(new java.awt.Color(204, 204, 204));
        ...
        rbEstado.setName("estado"); // NOI18N
    ...
    private void buttonMostrar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMostrar1ActionPerformed
        ...
        if (usuarios.getSelectedRow() == -1) {
            JOptionPane.showInternalMessageDialog(this, "Seleccione un usuario ");
        } else {
            abrir();
            perfi.setVisible(true);
            perfi.setSize(447, 487);
