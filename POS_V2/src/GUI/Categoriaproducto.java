...
public class Categoriaproducto extends javax.swing.JInternalFrame {
    ...
    public void setFiltroTexto() {
        Helper.setFiltraEntrada(nombre.getDocument(), FiltraEntrada.DEFAULT, 100, true);
        Helper.setFiltraEntrada(txtDato.getDocument(), FiltraEntrada.DEFAULT, 100, true);
    }
...
//    }
    private void Llenar() {
        try {
            ...
            Utilidades.ajustarAnchoColumnas(categoria);
            //formatotabla();
