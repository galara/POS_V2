...
public class BackupDiario {
    ...
    //public static String dataBase1 = "pos";//"rubens";//"agrofatima2"; //nombre base de datos
    public static String user1 = "root";//rubens";//"agrofatima2"; // usuario de la base de datos
    ...
    public static void GenerarBackupDiarioMySQL() {
        ...
        if (existe == false) {
            try {
                ...
                //Process child = runtime.exec("C:\\Program Files (x86)\\MySQL\\MySQL Server 5.5\\bin\\mysqldump -u " + BdConexion.user + " -p" + BdConexion.pass + " --default-character_set=utf8 " + BdConexion.dataBase);
                Process child = runtime.exec("C:\\xampp\\mysql\\bin\\mysqldump -u " + user1 + " -p" + pass1 + " --default-character_set=utf8 " + BdConexion.dataBase);
