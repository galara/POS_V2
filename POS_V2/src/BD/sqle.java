 ...
 */
public class sqle {
    public static final String LLENAR = "select * from empresa";
    public static final String BUSCANIT = "select * from clientes where idclientes=";
    public static final String BUSCANOMBRE = "select * from empresa where nombre like '%";
    ...
    public static final String UPDATEC = "update empresa set  nombre=?, direccion=?, correo=?, nit=?, telefono=?,Estado=?,fec_reg=? where idclientes=?";
