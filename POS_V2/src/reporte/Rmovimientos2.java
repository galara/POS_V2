...
public class Rmovimientos2 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnCerrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons_menu/icons8-Cerrar ventana-32.png"))); // NOI18N
        btnCerrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCerrarActionPerformed(evt);
            }
        });
        jPanel3.add(btnCerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 10, 40, 40));
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 800, 190));

        btnGenerar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons_menu/icons8-Imprimir-32.png"))); // NOI18N
        btnGenerar.setText("Generar Comprobante de Compra");
        ...
        jPanel1.add(btnGenerar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 450, 260, 50));

        btnVer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons_menu/icons8-Para hacer-32.png"))); // NOI18N
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 800, 160));

        jPanel3.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 840, 510));
        ...
        getContentPane().add(jcMousePanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 860, 600));
